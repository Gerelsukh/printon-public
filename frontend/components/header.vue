                    ...
                    <li class="nav-item">
                        ...
                        <v-navigation-drawer
                            ...
                            >
                                ...
                                <v-list-item>
                                    <v-list-item-title><a class="link nav-item-extra" href="http://localhost:3000/signin"><div class="slider"><v-btn outlined rounded class="btn-item" color="#25BC3D"><span class="signin">Sign in</span></v-btn></div></a></v-list-item-title>
                                </v-list-item>
                                <v-list-item>
                                    <v-list-item-title><a class="link nav-item-extra" href="http://localhost:3000/signup"><div class="slider"><v-btn rounded class="btn-item" color="#25BC3D"><span class="signup">Sign up</span></v-btn></div></a></v-list-item-title>
                                </v-list-item>
                                </v-list-item-group>
                            </v-list>
                            </v-navigation-drawer>
...
.nav-item .link .nav-item-extra .link-item{
    padding-left: 3px;
}
.link {
